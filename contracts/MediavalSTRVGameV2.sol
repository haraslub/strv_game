...
contract MediavalSTRVGameV2 is BurningContract, Ownable, VRFConsumerBase {
    ...
    external returns (bool) {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "BurningContract: must have admin role to change variables");
